...
- LLM help command (`llm-help`) to provide structured output for AI assistants working with the CLI

## [1.2.0] - 2026-01-03

### Added

- Checklist complete-item command to mark checklist items as complete
- UpdateCheckItemState method to client for checklist item state management

## [1.1.1] - 2026-01-03

### Added

- Version number to help command
- Added a nudge to use the `schema` command to see all commands and args (for LLMs) 

## [1.1.0] - 2026-01-03

### Added

- Schema command with full output of what's available
- `--desc` flag to card and board to allow specifying description during board and card creation
...
[Unreleased]: https://github.com/danbruder/trello-cli/compare/v1.3.0...HEAD
[1.3.0]: https://github.com/danbruder/trello-cli/compare/v1.2.0...v1.3.0
[1.2.0]: https://github.com/danbruder/trello-cli/compare/v1.1.2...v1.2.0
[1.1.2]: https://github.com/danbruder/trello-cli/compare/v1.1.1...v1.1.2
[1.1.1]: https://github.com/danbruder/trello-cli/compare/v1.1.0...v1.1.1
[1.1.0]: https://github.com/danbruder/trello-cli/compare/v1.0.4...v1.1.0
